...
const storeContext = null;
// @customElement('fzn-layout')
class Layout extends contextConnect(storeContext)(EnhancedEventTargetMixin(LitElement)) {
    constructor() {
        super(...arguments);
        this._uuid = uuid();
        this.layout = this;
...
], Layout.prototype, "routerContext", void 0);
__decorate([
...
__decorate([
    property({ attribute: false })
], Layout.prototype, "contentTitle", null);
__decorate([
    property({ attribute: true, type: Boolean, reflect: true })
], Layout.prototype, "collapsed", void 0);
__decorate([
    state()
], Layout.prototype, "userAvatarUrl", void 0);
__decorate([
    state()
], Layout.prototype, "pageHandlesPadding", void 0);
__decorate([
    state()
], Layout.prototype, "contentFramePadding", void 0);
__decorate([
    query(':host > div > .action-bar')
], Layout.prototype, "actionBar", void 0);
__decorate([
    query(':host > div > .content-frame')
], Layout.prototype, "contentFrame", void 0);
__decorate([
    query('fzn-drawer')
], Layout.prototype, "drawer", void 0);
__decorate([
    state()
], Layout.prototype, "drawerOpen", void 0);
__decorate([
    property({ type: Number })
], Layout.prototype, "drawerMaxWidth", void 0);
__decorate([
    state()
], Layout.prototype, "drawerWidth", void 0);
